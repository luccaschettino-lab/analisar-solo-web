...
function Barra({ max, limiar }) {
  ...
  return (
    <div
      aria-hidden="true"
      className="h-3 w-full rounded border border-slate-300 dark:border-white/20"
...
export default function LegendaDivergente({ comparacao, criterio = null, elevada = false }) {
  ...
  return (
    <aside
      className={`vidro-forte absolute right-2 z-[1100] w-auto rounded-lg border border-slate-200 shadow-painel dark:border-white/15 md:right-3 md:w-64 md:p-3 ${
    ...
    >
      ...
      <div className={`${aberta ? 'w-64 max-w-[80vw] p-3 pt-0' : 'hidden'} md:block md:w-auto md:max-w-none md:p-0`}>
        ...
        <div className="mt-2">
          ...
          <div className="mt-1 flex justify-between text-[11px] leading-tight text-slate-600 dark:text-slate-400">
        ...
        <ul className="mt-2 space-y-1 border-t border-slate-200 pt-1.5 dark:border-white/10">
          <li className="flex items-start gap-2">
            ...
            <span className="text-xs leading-tight text-slate-700 dark:text-slate-300">
              <span className="font-medium text-slate-900 dark:text-slate-100">Sem dado em um dos anos</span>
              <span className="block text-slate-500 dark:text-slate-400">não há variação a calcular</span>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span
            ...
            />
            <span className="text-xs leading-tight text-slate-700 dark:text-slate-300">
              <span className="font-medium text-slate-900 dark:text-slate-100">Sem dado nos dois anos</span>
              <span className="block text-slate-500 dark:text-slate-400">gleba nunca amostrada nesta profundidade</span>
            </span>
          </li>
        </ul>
